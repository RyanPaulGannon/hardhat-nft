...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    // When we mint, it will trigger a Chainlink VRF event to get a random number
        ...
        override
    {
        ...
        Breed dogBreed = getBreedFromModdenRng(moddedRng);
    ...
    function getBreedFromModdenRng(uint256 moddedRng)
        public
        pure
        returns (Breed)
    {
    ...
    function getChanceArray() public pure returns (uint256[3] memory) {
        // Index 0 has a 10% chance, index 1 has 20% and index 2 has 60% chance
        // Index 1 is 30% minus index[0] 10% so therefore 20%
